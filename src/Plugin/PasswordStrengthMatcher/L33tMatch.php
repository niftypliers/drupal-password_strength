...
/**
 * @file
 * Contains Drupal\password_strength\Plugin\PasswordStrengthMatcher\L33tMatch.
 */

namespace Drupal\password_strength\Plugin\PasswordStrengthMatcher;

use Drupal\password_strength\Plugin\PasswordStrengthMatcher\DictionaryMatch;

/**
 * Matches l33t speak words used in passwords.
 *
 * @PasswordStrengthMatcher(
 *   id = "password_strength_l33t_match",
