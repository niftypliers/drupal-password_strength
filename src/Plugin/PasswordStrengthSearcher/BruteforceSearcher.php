...
/**
 * @file
 * Contains Drupal\password_strength\Plugin\PasswordStrengthSearcher\BruteforceSearcher.
 */

namespace Drupal\password_strength\Plugin\PasswordStrengthSearcher;

use Drupal\password_strength\Plugin\PasswordStrengthMatcher\Bruteforce;
use Drupal\password_strength\SearcherBase;

/**
 * Recursively checks character segments of the password.
 *
 * @PasswordStrengthSearcher(
 *   id = "password_strength_bruteforce_searcher",
 *   title = @Translation("Brute force algorithm for Password Strength searching"),
 *   description = @Translation("A class for setting up brute force search for Password Strength"),
 * )
 */
class BruteforceSearcher extends SearcherBase {
